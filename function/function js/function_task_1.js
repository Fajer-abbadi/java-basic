...
*/
function tellFortune( number_of_children,partnersname,location, job_title)
{console.log("You will be a "+ job_title +" in "+location +", and married to " + partnersname+" with "+  number_of_children +" kids");

}
tellFortune( 3,"ahmad","amman", "teacher");
...
{console.log("Your doggie is"+puppys_age*7 +"years old in dog years!");

}calculateDogAge(puppys_age=prompt("inter"));
/*
3
...
*/
 ...
 let cups=(100-age)*amountperday*365
